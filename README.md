...
<div align="center">
  ...
  <h3><b>Bookstore Using Reactjs</b></h3>
...
The Bookstore is a website similar to the "Awesome Books" site.
I created a simplified version of it that allows users to:
...
-  git clone https://github.com/Kanyorok/bookstore.git
```sh
  npm install
```
